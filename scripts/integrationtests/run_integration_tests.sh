...
# 11. lowercase_columns=true
run_test 11 "Lowercase Columns = true" "conversion.options.lowercase_columns=true;conversion.options.tableddl=true"

# 12. lowercase_columns=false
run_test 12 "Lowercase Columns = false" "conversion.options.lowercase_columns=false;conversion.options.tableddl=true"

# 13. skip_existing_tables=true
run_test 13 "Skip Existing Tables = true" "conversion.options.skip_existing_tables=true;conversion.options.tableddl=true"

# 14. use_table_list=true
run_test 14 "Use Table List" "conversion.options.use_table_list=true;conversion.options.table_list=[case_01_integers];conversion.options.tableddl=true"

# 15. exclude_use_table_list=true
run_test 15 "Exclude Table List" "conversion.options.exclude_use_table_list=true;conversion.options.exclude_table_list=[case_01_integers];conversion.options.tableddl=true"

# 16. validate_data=true
run_test 16 "Validate Data = true" "conversion.options.validate_data=true;conversion.options.data=true"

# 17. validate_data=false
run_test 17 "Validate Data = false" "conversion.options.validate_data=false;conversion.options.data=true"

# 18. truncate_before_sync=true
run_test 18 "Truncate Before Sync = true" "conversion.options.truncate_before_sync=true;conversion.options.data=true"

# 19. truncate_before_sync=false
run_test 19 "Truncate Before Sync = false" "conversion.options.truncate_before_sync=false;conversion.options.data=true"

# 20. show_progress=true
run_test 20 "Show Progress = true" "run.show_progress=true;conversion.options.tableddl=true"

# 21. show_progress=false
run_test 21 "Show Progress = false" "run.show_progress=false;conversion.options.tableddl=true"

# 22. enable_file_logging=true
run_test 22 "Enable File Logging = true" "run.enable_file_logging=true;conversion.options.tableddl=true"

# 23. enable_file_logging=false
run_test 23 "Enable File Logging = false" "run.enable_file_logging=false;conversion.options.tableddl=true"

# 24. show_console_logs=true
run_test 24 "Show Console Logs = true" "run.show_console_logs=true;conversion.options.tableddl=true"

# 25. show_console_logs=false
# This will override the default show_console_logs=true we added in run_test
run_test 25 "Show Console Logs = false" "run.show_console_logs=false;conversion.options.tableddl=true"

# 26. show_log_in_console=true
run_test 26 "Show Log In Console = true" "run.show_log_in_console=true;conversion.options.tableddl=true"

# 27. show_log_in_console=false
run_test 27 "Show Log In Console = false" "run.show_log_in_console=false;conversion.options.tableddl=true"
