-- ==============================================
-- MySQL2PG 索引测试文件 - 索引特点说明
-- ==============================================
-- 本文件包含多种MySQL索引类型，用于测试MySQL到PostgreSQL的迁移兼容性
-- 
-- 索引类型分类及特点：
-- 1. 基础索引类型
...
--    - SPATIAL → PostGIS扩展
--    - HASH分区 → 需转换为RANGE或LIST分区
--    - MyISAM/MEMORY → 转换为普通表
--    - 无符号类型 → 转换为有符号类型+CHECK约束
-- ==============================================


-- 每个表都有对应的索引，语法兼容MySQL5.7 和MySQL8.0
